...
echo "${ENV_IP_PREFIX}.11 artifactory-postgres.${ENV_DOMAIN}"
echo "${ENV_IP_PREFIX}.12 keycloak-init.${ENV_DOMAIN}"
echo "${ENV_IP_PREFIX}.13 cas-proxy.${ENV_DOMAIN}"
echo "${ENV_IP_PREFIX}.14 artifactory-init.${ENV_DOMAIN}"
